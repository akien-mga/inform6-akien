! ---------------------------------------------------------------------------- !
!   Scenic.h => scenic5sens.h
!       extended      Aug08 by Samuel Verschelde : added scenic_allactions
!       extended      May07 by Samuel Verschelde for the game "Lieux communs"
...
! Objet factice pour éviter les erreurs de compilation
Object ScenicFakeObject
with
    scenic_allactions 'fake' 0 NULL,
    scenic_allactions2 'fake' 0 NULL,
    scenic_allactions3 'fake' 0 NULL,
    scenic_allactions4 'fake' 0 NULL,
    scenic_all 'fake' 0 NULL,
    scenic_all2 'fake' 0 NULL,
    scenic_all3 'fake' 0 NULL,
    scenic_all4 'fake' 0 NULL,
    scenic_look 'fake' 0 NULL,
    scenic_look2 'fake' 0 NULL,
    scenic_look3 'fake' 0 NULL,
    scenic_look4 'fake' 0 NULL,
    scenic_smell 'fake' 0 NULL,
    scenic_smell2 'fake' 0 NULL,
    scenic_smell3 'fake' 0 NULL,
    scenic_smell4 'fake' 0 NULL,
    scenic_listen 'fake' 0 NULL,
    scenic_listen2 'fake' 0 NULL,
    scenic_listen3 'fake' 0 NULL,
    scenic_listen4 'fake' 0 NULL,
    scenic_touch 'fake' 0 NULL,
    scenic_touch2 'fake' 0 NULL,
    scenic_touch3 'fake' 0 NULL,
    scenic_touch4 'fake' 0 NULL,
    scenic_taste 'fake' 0 NULL,
    scenic_taste2 'fake' 0 NULL,
    scenic_taste3 'fake' 0 NULL,
    scenic_taste4 'fake' 0 NULL;

! The message when you "OTHERVERB swd".
!Default ScenicError "That's just scenery.";

[ GetScenicDesc obj swd typeaction x y z;
        ...
        if (typeaction == 1)
        {
            if (obj provides scenic_look && swd)
            {
                x = obj.&scenic_look; y = x + obj.#scenic_look; z = 0;
            ...
            if (obj provides scenic_look2 && swd)
            {
                x = obj.&scenic_look2; y = x + obj.#scenic_look2; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_look3 && swd)
            {
                x = obj.&scenic_look3; y = x + obj.#scenic_look3; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_look4 && swd)
            {
                x = obj.&scenic_look4; y = x + obj.#scenic_look4; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
        ...
        if (typeaction == 2)
        {
            if (obj provides scenic_smell && swd)
            {
                x = obj.&scenic_smell; y = x + obj.#scenic_smell; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_smell2 && swd)
            {
                x = obj.&scenic_smell2; y = x + obj.#scenic_smell2; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_smell3 && swd)
            {
                x = obj.&scenic_smell3; y = x + obj.#scenic_smell3; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_smell4 && swd)
            {
                x = obj.&scenic_smell4; y = x + obj.#scenic_smell4; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
        ...
        if (typeaction == 3)
        {
            if (obj provides scenic_listen && swd)
            {
                x = obj.&scenic_listen; y = x + obj.#scenic_listen; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_listen2 && swd)
            {
                x = obj.&scenic_listen2; y = x + obj.#scenic_listen2; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_listen3 && swd)
            {
                x = obj.&scenic_listen3; y = x + obj.#scenic_listen3; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_listen4 && swd)
            {
                x = obj.&scenic_listen4; y = x + obj.#scenic_listen4; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
        ...
        if (typeaction == 4)
        {
            if (obj provides scenic_touch && swd)
            {
                x = obj.&scenic_touch; y = x + obj.#scenic_touch; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_touch2 && swd)
            {
                x = obj.&scenic_touch2; y = x + obj.#scenic_touch2; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_touch3 && swd)
            {
                x = obj.&scenic_touch3; y = x + obj.#scenic_touch3; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_touch4 && swd)
            {
                x = obj.&scenic_touch4; y = x + obj.#scenic_touch4; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
        ...
        if (typeaction == 5)
        {
            if (obj provides scenic_taste && swd)
            {
                x = obj.&scenic_taste; y = x + obj.#scenic_taste; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_taste2 && swd)
            {
                x = obj.&scenic_taste2; y = x + obj.#scenic_taste2; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_taste3 && swd)
            {
                x = obj.&scenic_taste3; y = x + obj.#scenic_taste3; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_taste4 && swd)
            {
                x = obj.&scenic_taste4; y = x + obj.#scenic_taste4; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z) 
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
        ...
        ! 5 sens confondus, si aucun des autres scenic n'a fourni de réponse
        if (typeaction ~= 6) ! 6 représente "toute action autre que les 5 sens"
        {
            if (obj provides scenic_all && swd)
            {
                x = obj.&scenic_all; y = x + obj.#scenic_all; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z)
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_all2 && swd)
            {
                x = obj.&scenic_all2; y = x + obj.#scenic_all2; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z)
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_all3 && swd)
            {
                x = obj.&scenic_all3; y = x + obj.#scenic_all3; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z)
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
            ...
            if (obj provides scenic_all4 && swd)
            {
                x = obj.&scenic_all4; y = x + obj.#scenic_all4; z = 0;
                for ( : x<y : x=x+WORDSIZE) switch (z)
                {
                    0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                    1:  if (0 == x-->0) z = z + 2;
        ...
        ! N'importe quelle action interceptée, si aucun des autres scenic n'a fourni de réponse
        ! et que scenic_allactions est renseigné
        if (obj provides scenic_allactions && swd)
        {
            x = obj.&scenic_allactions; y = x + obj.#scenic_allactions; z = 0;
            for ( : x<y : x=x+WORDSIZE) switch (z)
            {
                0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                1:  if (0 == x-->0) z = z + 2;
        ...
        if (obj provides scenic_allactions2 && swd)
        {
            x = obj.&scenic_allactions2; y = x + obj.#scenic_allactions2; z = 0;
            for ( : x<y : x=x+WORDSIZE) switch (z)
            {
                0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                1:  if (0 == x-->0) z = z + 2;
        ...
        if (obj provides scenic_allactions3 && swd)
        {
            x = obj.&scenic_allactions3; y = x + obj.#scenic_allactions3; z = 0;
            for ( : x<y : x=x+WORDSIZE) switch (z)
            {
                0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                1:  if (0 == x-->0) z = z + 2;
        ...
        if (obj provides scenic_allactions4 && swd)
        {
            x = obj.&scenic_allactions4; y = x + obj.#scenic_allactions4; z = 0;
            for ( : x<y : x=x+WORDSIZE) switch (z)
            {
                0:  if (0 == x-->0) z = z + 2; if (swd == x-->0) z++;
                1:  if (0 == x-->0) z = z + 2;
        ...
        ! Si on arrive là c'est que l'objet n'a pas été trouvé bien
        ! que le nom cherché soit dans le "dictionnaire".
        ! Chercher si le nom est dans une des propriétés scenic "look", "touch" ou "taste"
        ! (pas écouter ou sentir car il peut s'agir d'objets lointains et non visibles)
        ! Si c'est le cas renvoyer "NULL" qui permettra d'afficher le message de base
        ! "You don't need to refer to that" au lieu de "You can't see any such thing".
        if (typeaction ~= 6) ! 6 représente "toute action autre que les 5 sens"
        {
            if (obj provides scenic_look && swd)
            {
...
Default ScenicErrorOther = NULL;
Default ScenicErrorLook = NULL;
Default ScenicErrorSmell = NULL;
Default ScenicErrorListen = NULL;
Default ScenicErrorTouch = NULL;
Default ScenicErrorTaste = NULL;

[ ScenicPrintOrRun x y typeaction;
    ...
    ScenicWord = false;
! 2007-04-30 Samuel : la ligne qui suit provoque des erreurs. Je la commente.
!        SetPronoun('it', NULL); SetPronoun('them', NULL);
    if (x == NULL) 
    {
        ...
        if (typeaction == 0)
        {
            if (ScenicErrorOther~=NULL)
                print (string)ScenicErrorOther, "^";
            else
                L__M(##Miscellany, 39);
        }
        ! Look
        if (typeaction == 1)
        {
            if (ScenicErrorLook~=NULL)
                print (string)ScenicErrorLook, "^";
            else
                L__M(##Miscellany, 39);
        }
        ! Smell
        if (typeaction == 2)
        {
            if (ScenicErrorSmell~=NULL)
                print (string)ScenicErrorSmell, "^";
            else
                L__M(##Smell);
        }
        ! Listen
        if (typeaction == 3)
        {
            if (ScenicErrorListen~=NULL)
                print (string)ScenicErrorListen, "^";
            else
                L__M(##Listen);
        }
        ! Touch
        if (typeaction == 4)
        {
            if (ScenicErrorTouch~=NULL)
                print (string)ScenicErrorTouch, "^";
            else
                print "Vous n'y voyez pas d'utilité.^";
        }
        ! Taste
        if (typeaction == 5)
        {
            if (ScenicErrorTaste~=NULL)
                print (string)ScenicErrorTaste, "^";
            else
                print "Vous n'y voyez pas d'utilité.^";
        }
    }
...
[ CheckScenicExamine obj typeaction x;
        ! If obj provides a 'scenic' property, check if it includes ScenicWord.
        ! If so, print/run the description.
        x = GetScenicDesc(obj, ScenicWord, typeaction); if (x) {
            ScenicPrintOrRun(x, $0002, typeaction);
            }
];
...
[ CheckScenicOther obj x;
        ...
        ! Samuel : first try to print a message from scenic_allactions
        x = GetScenicDesc(obj, ScenicWord, 6);
        if (x) {
            ScenicPrintOrRun(x, $0002, 0);
        }
        else {
            x = GetScenicDesc(obj, ScenicWord); if (x) {
                if (x ~= NULL) x = ScenicErrorOther;
                ScenicPrintOrRun(x, $0001, 0);
                }
        }
];
...
[ Handle_CANTSEE_PE;
    ...
    wn = oops_from;
    do {
        ScenicWord = NextWordStopped();
    } until (ScenicWord == -1
             ! Ne pas prendre les articles et prépositions
             ! J'ai tenté d'être exhaustif mais la méthode ne me plaît pas,
             ! trop dépendante de l'ajout de nouvelles prépositions à FrenchG.h
             || (ScenicWord ~= 'le' or 'la' or 'l^' or 'l' or 'les' or 'un' or 'une' or 'de' or 'des' or 'du' or 'd^'
                 && ScenicWord ~= 'dans' or 'par' or 'vers' or 'sur' or 'en' or 'à' or 'a' or 'au' or 'aux' or 'dessus' or 'dessous' or 'sous' or 'avec' or 'derriere'));
    if (ScenicWord == -1) ScenicWord = 0; ! pour le test IF plus bas
    #IfDef DEBUG;
    if (ScenicWord) print "[", (address) ScenicWord, "]^";
    #Endif;

    if (ScenicWord) {
        if (action_to_be == ##Examine or ##Search or ##Consult) {
            CheckScenicExamine(location, 1);
            if (ScenicWord) LoopOverScope(CheckScenicExamine);
        }
        else if (action_to_be == ##Smell) {
            CheckScenicExamine(location, 2);
            if (ScenicWord) LoopOverScope(CheckScenicExamine);
        }
        else if (action_to_be == ##Listen) {
            CheckScenicExamine(location, 3);
            if (ScenicWord) LoopOverScope(CheckScenicExamine);
        }
        else if (action_to_be == ##Touch or ##Take) {
            CheckScenicExamine(location, 4);
            if (ScenicWord) LoopOverScope(CheckScenicExamine);
        }
        else if (action_to_be == ##Taste or ##Eat or ##Drink) {
            CheckScenicExamine(location, 5);
            if (ScenicWord) LoopOverScope(CheckScenicExamine);
        }
        else {
...
[ Handle_SCENERY_PE;
    ...
    if (ScenicFlag & $0004) {
        if (action_to_be == ##Examine or ##Consult) {
        ...
        ! Remarque : action_to_be n'est pas 100% fiable
        ! il semble contenir l'action de la dernière ligne de grammaire
        ! du verbe utilisé.
        if (action_to_be == ##Search ) {
            print "Soyez plus précis sur ce que vous voulez fouiller.^";
            rtrue;
        }
        if (action_to_be == ##Enter ) {
            print "Vous y êtes déjà.^";
            rtrue;
        }
        if (action_to_be == ##Exit) {
            <<Exit>>;
        }
        if (action_to_be == ##Smell) {
            <<Smell>>;
        }
        if (action_to_be == ##Taste) {
            if (ScenicErrorTaste~=NULL)
                print (string)ScenicErrorTaste, "^";
            else
                print "Vous n'y voyez pas d'utilité.^";
        ...
        ! Par défaut utiliser le message défini par l'auteur
        if (ScenicErrorOther~=NULL)
            print (string)ScenicErrorOther, "^";
        else
            L__M(##Miscellany, 39);
